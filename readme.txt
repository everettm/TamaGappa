...
2. Overall the game is fairly robust. There are a few issues that we weren't able to work out, however, and features we didn't fully implement.
...
- The maze game is only implemented on a foundational level.
